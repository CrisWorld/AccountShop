<%-- 
    Document   : header
    Created on : 1 Jul 2024, 20:40:14
    Author     : quoch
--%>
...
<!--                            <a href="/admin/dashboard" class="logo logo-dark">
                            ...
                            <a href="/admin/dashboard" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="/admin/assets/images/logo-light.png" alt="logo-light" height="20">
                                </span>
                            </a>
                        </div>
...
<!--                        <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<c:out value="<%= user.getImage() %>" default="/admin/assets/images/users/avatar-1.jpg" />"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1"><%= user.getFullname() %></span>
...
<!--                                <a class="dropdown-item" href="#"><i class="ri-user-line align-middle me-1"></i> Profile</a>
                                ...
                                <form action="/auth/admin?action=logout" method="post">
                                    <button class="dropdown-item text-danger" href="#"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</button>
                                </form>
