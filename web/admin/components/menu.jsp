<%-- 
    Document   : menu.jsp
    Created on : 1 Jul 2024, 20:41:36
    Author     : quoch
--%>
...
<div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        <div class="">
                            <img src="<c:out value="<%= user.getImage() %>" default="/admin/assets/images/users/avatar-1.jpg" />" alt="" class="avatar-md rounded-circle">
                        </div>
                        <div class="mt-3">
                            <h4 class="font-size-16 mb-1"><%= user.getFullname() %></h4>
